export class CONSTANTES {
    ...
    public static CONST_TITLE_SELECCIONE_ITEM_MEDIOSDEPAGO = 'Seleccione un Medio de Pago';
    ...
    public static CONST_TITLE_CONFIGURACION_DE_MEDIOSDEPAGO = 'Configuración de Medios de Pago';
